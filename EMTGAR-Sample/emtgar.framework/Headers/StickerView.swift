...
class StickerView: UIView {
    ...
    init(contentView: UIView) {
        ...
        self.addGestureRecognizer(self.rotatePinchGesture)
        ...
        self.showEditingHandlers = false
        self.enableClose = false
        self.enableRotate = false
        self.enableFlip = false
        let frameworkBundle = Bundle().emtgarResourceBundle
        self.setImage(UIImage(named: "close_sticker", in: frameworkBundle, compatibleWith: nil), forHandler: StickerViewHandler.close)
        self.setImage(UIImage(named: "rotate_sticker", in: frameworkBundle, compatibleWith: nil), forHandler: StickerViewHandler.rotate)
        self.setImage(UIImage(named: "flip_sticker", in: frameworkBundle, compatibleWith: nil), forHandler: StickerViewHandler.flip)
        self.minimumSize = self.defaultMinimumSize
        self.outlineBorderColor = .clear
    }
    ...
    private lazy var rotatePinchGesture = {
        return UIPinchGestureRecognizer(target: self, action: #selector(handleRotatePinchGesture(_:)))
    }()
    private lazy var rotate = {
        return UIRotationGestureRecognizer(target: self, action: #selector(handleRotate(_:)))
    }()
    ...
    @objc
    func handleRotatePinchGesture(_ recognizer: UIPinchGestureRecognizer) {
